# 🧪 ThermoMaven v1.4.7-beta - Fix « indisponible » après connexion
...
2. Cliquer sur **Mise à jour** et choisir **v1.4.7-beta** (ou « Redémarrer » puis mettre à jour si la beta n’apparaît pas encore).
3. **Redémarrer Home Assistant**

### Mise à jour manuelle
1. Télécharger [v1.4.7-beta](https://github.com/djiesr/thermomaven-ha/releases/tag/v1.4.7-beta)
...
**Full Changelog:** [v1.4.6...v1.4.7-beta](https://github.com/djiesr/thermomaven-ha/compare/v1.4.6...v1.4.7-beta)
